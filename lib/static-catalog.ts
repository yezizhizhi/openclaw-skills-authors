...
const scenarioAliases: Record<string, string[]> = {
  ...
  "copywriting:热点/需求调研": ["热点调研", "需求调研", "市场机会", "用户需求", "趋势判断", "痛点挖掘"],
  "copywriting:竞品调研与拆解": ["竞品调研", "竞品拆解", "对标分析", "差异化定位", "竞品分析", "卖点对比"],
  "copywriting:内容策划与矩阵设计": ["内容策划", "内容矩阵", "社媒规划", "栏目设计", "平台节奏", "选题规划"],
  "copywriting:内容生产与平台改写": ["内容生产", "平台改写", "正文写作", "带货文案", "小红书文案", "种草文案"],
  "copywriting:成交链路与活动转化": ["成交链路", "活动转化", "私域转化", "宣传文案", "上新活动", "email sequence"],
  "copywriting:短视频与直播表达": ["抖音文案", "短视频口播", "直播话术", "带货脚本", "douyin", "直播转化"],
  "copywriting:润色去 AI 味": ["润色", "去ai味", "口语化", "文案润色", "脚本自然化", "表达优化"],
  ...
  "academic:研究任务定义": ["研究规划", "研究问题", "开题规划", "研究路线", "任务拆解", "开题设计"],
  "academic:文献收集 / 研究材料归档": ["文献收集", "文献检索", "论文下载", "研究材料", "资料归档", "pdf抓取"],
  "academic:学术检索 / 外部数据库补强": ["学术检索", "外部数据库", "arxiv检索", "学术搜索", "数据库补强", "跨源研究"],
  "academic:文献整理 / 摘要提炼": ["文献整理", "摘要提炼", "论文摘要", "文献综述", "研究笔记", "digest"],
  "academic:研究结构 / 正文写作": ["论文写作", "正文写作", "研究结构", "章节草稿", "latex", "研究报告"],
...
const skillScenarioNames: Record<string, string[]> = {
  ...
  "copywriting:Market Research": ["热点/需求调研"],
  "copywriting:Competitor Research": ["竞品调研与拆解"],
  "copywriting:Competitive Analysis": ["竞品调研与拆解"],
  "copywriting:Competitor Analyst": ["竞品调研与拆解"],
  "copywriting:Research Planner": ["热点/需求调研"],
  "copywriting:SEO Research Master": ["热点/需求调研"],
  "copywriting:Digital Marketing": ["内容策划与矩阵设计"],
  "copywriting:Content Marketing": ["内容策划与矩阵设计"],
  "copywriting:content-strategy": ["内容策划与矩阵设计"],
  "copywriting:Social Media Marketing": ["内容策划与矩阵设计"],
  "copywriting:social-media-manager": ["内容策划与矩阵设计"],
  "copywriting:Content Production": ["内容生产与平台改写"],
  "copywriting:Copywriting": ["内容生产与平台改写", "成交链路与活动转化"],
  "copywriting:Content": ["内容生产与平台改写"],
  "copywriting:Humanizer": ["润色去 AI 味"],
  "copywriting:Email Sequence Builder": ["成交链路与活动转化"],
  "copywriting:Product Launch": ["成交链路与活动转化"],
  "copywriting:Pump": ["成交链路与活动转化"],
  "copywriting:Douyin": ["短视频与直播表达"],
  "copywriting:Douyin Live": ["短视频与直播表达"],
  "copywriting:XHS Content Generate": ["内容生产与平台改写"],
  "reports:Executive Summary Press": ["资料归纳", "重点提炼", "报告成稿", "摘要压缩"],
  "reports:Logic Line Checker": ["框架整理", "报告成稿", "逻辑校对"],
  "academic:academic-deep-research": ["研究任务定义", "学术检索 / 外部数据库补强"],
  "academic:aclawdemy": ["研究任务定义"],
  "academic:call-academic-search-agent": ["研究任务定义", "学术检索 / 外部数据库补强"],
  "academic:writing-plans": ["研究任务定义", "研究结构 / 正文写作"],
  "academic:literature-manager": ["文献收集 / 研究材料归档", "引用辅助 / 参考文献管理"],
  "academic:paperzilla": ["文献收集 / 研究材料归档"],
  "academic:pz": ["文献收集 / 研究材料归档"],
  "academic:pubmed-edirect": ["文献收集 / 研究材料归档"],
  "academic:xy-pubmed-pdf-downloader": ["文献收集 / 研究材料归档"],
  "academic:aminer-open-academic": ["文献收集 / 研究材料归档"],
  "academic:swiftscholar-skill": ["学术检索 / 外部数据库补强"],
  "academic:web-search-pro": ["学术检索 / 外部数据库补强"],
  "academic:arxiv-cli-tools": ["学术检索 / 外部数据库补强"],
  "academic:agent-deep-research": ["学术检索 / 外部数据库补强"],
  "academic:wolfram-alpha": ["学术检索 / 外部数据库补强"],
  "academic:agentic-paper-digest-skill": ["文献整理 / 摘要提炼"],
  "academic:arxiv-watcher": ["文献整理 / 摘要提炼"],
  "academic:arxiv-paper-reviews": ["文献整理 / 摘要提炼"],
  "academic:arxiv-paper-processor": ["文献整理 / 摘要提炼"],
  "academic:arxiv-summarizer-orchestrator": ["文献整理 / 摘要提炼"],
  "academic:note-processor": ["文献整理 / 摘要提炼"],
  "academic:arxiv-batch-reporter": ["文献整理 / 摘要提炼"],
  "academic:academic-writing": ["研究结构 / 正文写作", "语言润色 / 学术语体优化"],
  "academic:academic-writer": ["研究结构 / 正文写作"],
  "academic:research-report": ["研究结构 / 正文写作"],
  "academic:agentarxiv": ["研究结构 / 正文写作"],
  "academic:academic-writing-refiner": ["语言润色 / 学术语体优化"],
  "academic:ai-review": ["语言润色 / 学术语体优化"],
  "academic:chain-of-density": ["语言润色 / 学术语体优化", "文献整理 / 摘要提炼"],
  "academic:lore": ["引用辅助 / 参考文献管理"],
  "academic:research-paper-kb": ["引用辅助 / 参考文献管理"],
  "academic:citation-finder": ["引用辅助 / 参考文献管理"],
  "academic:capacities": ["引用辅助 / 参考文献管理", "文献整理 / 摘要提炼"],
  "academic:aoi-triple-memory-lite": ["引用辅助 / 参考文献管理"],
  "academic:self-review": ["逻辑一致性 / 终稿审校"],
  "academic:boof": ["逻辑一致性 / 终稿审校"],
